...
export class Rpi10In3 implements DisplayDevice {
    ...
    constructor(public readonly orientation = Orientation.Horizontal, public readonly colorMode = ColorMode.Black) {
        ...
        this.driver = bindings('waveshare10in3');
        this.width = this.orientation === Orientation.Horizontal ? 1872 : 1404;
        this.height = this.orientation === Orientation.Horizontal ? 1404 : 1872;
    }
